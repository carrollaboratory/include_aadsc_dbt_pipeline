...
with ftd_condition as (
    select 
       ...
       c.condition_or_measure_source_text::text as "Condition or Measure Source Text",
       c.age_at_first_patient_engagement::integer as "Age At Condition or Measure Observation",
       ...
       c.maxo_label::text as "MAXO Label",
