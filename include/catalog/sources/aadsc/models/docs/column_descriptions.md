{% docs chicoine_down_syndrome_extract_description %}
Model for chicoine_down_syndrome_extract.
{% enddocs %}


{% docs chicoine_down_syndrome_extract_masked_id %}
None
{% enddocs %}


{% docs chicoine_down_syndrome_extract_age %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_extraction_date %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_height %}
None
{% enddocs %}


{% docs chicoine_down_syndrome_extract_weight %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_auto_narcolepsy_status %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_auto_other_specify %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_auto_t1_diabetes_status %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_change_in_skin_texture %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_disorder_of_adrenal_gland_unspecified %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_endo_vitamind_status %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_male_hypospadias_status %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_neuro_dementia_status %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_nonalcoholic_steatohepatitis %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_psych_odd_status %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_psych_panic_status %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_psych_schizophrenia_status %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_vitamin_b12_deficiency %}
None
{% enddocs %}
...
{% docs chicoine_down_syndrome_extract_xerosis_cutis %}
None
{% enddocs %}
...
{% docs aadsc_stg_clinical_zoster_herpes_zoster__dermatophytosis %}
...
{% docs aadsc_stg_clinical_auto_thrombo_purpura_status %}
...
Cardiac Condition - Current or Previous
{% enddocs %}
...
{% docs aadsc_stg_clinical_acute_myocardial_infarction %}
...
{% docs aadsc_stg_clinical_nephrolithiasis_kidney_stones %}
